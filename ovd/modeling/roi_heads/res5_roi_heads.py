...
class CustomRes5ROIHeads(Res5ROIHeads):
    ...
    def forward(self, images, features, proposals, targets=None, ann_type='box', des_feats = None):
        del images
        ...
        predictions = self.box_predictor(box_features.mean(dim=[2, 3]), des_feats = des_feats)
